...
export default function WhatWeDoPage() {
  return (
    <main className="min-h-screen flex flex-col">
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center">
          <div className="text-white">
            ...
            <p className="text-xl opacity-90">
              Empowering communities through sports and education
            </p>
          </div>
        </div>
      </section> */}
      ...
      <section className="md:py-16 px-8 md:px-16 py-8 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-[#B7E4A7] p-6 rounded-lg">
              <h3 className="text-xl font-bold mb-4">Key Areas of Impact</h3>
            ...
            <div className="bg-[#98c889] p-6 rounded-lg">
            ...
            {[
              ...
              >
                <div>
                  ...
                  <div className="text-gray-600">{program.category}</div>
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-16">
            {[
              ...
              >
                <div className="bg-[#B7E4A7] p-4 rounded-lg mb-4">
      ...
      <section className="py-16 md:px-16 px-8">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div>
              <h2 className="text-3xl font-bold mb-6">Featured Program</h2>
              <h3 className="text-2xl mb-4">Sports Coach</h3>
            </div>
          ...
          <div className="bg-[#B7E4A7] p-8 rounded-lg">
            ...
            <div className="grid md:grid-cols-2 gap-8 bg-[#98c889]/50 p-6 rounded-lg">
              <div>
