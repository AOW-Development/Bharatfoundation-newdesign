      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-8">
          ...
          <div className="flex gap-2">
            ...
            <button
              type="button"
              className="bg-[#16A34A] px-6 py-2 rounded-r-lg text-black font-semibold"
            >
              Enter
            </button>
          </div>
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col md:flex-row gap-4 mt-4 items-center">
            ...
            <button
              type="submit"
              className="w-full md:w-auto bg-[#16A34A] text-black font-bold py-3 px-6 rounded-lg hover:bg-[#a5d695] transition-colors disabled:bg-gray-400"
              disabled={isLoading}
            >
              {isLoading
                ? "Processing..."
