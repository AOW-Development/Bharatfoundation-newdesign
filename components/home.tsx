    ...
    <section className="relative min-h-screen w-full overflow-hidden pt-8 md:pt-10">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-12 min-h-screen flex items-center">
        <div className="w-full py-6 md:py-10">
          ...
          <div className="text-white space-y-4 sm:space-y-5 md:space-y-6 max-w-4xl animate-fade-in-up opacity-0 animate-slide-up"
               style={{ animationDelay: "0.2s" }}>

            {/* Heading */}
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight">
              Welcome to Bharat {" "}
              <span className="text-[#B8EA80] font-semibold">Sports</span> Foundation
            </h1>
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4 md:gap-5 pt-2 max-w-2xl">
              <div className="text-center md:text-left">
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#B8EA80]">100+</div>
                <div className="text-xs sm:text-sm md:text-base opacity-80 mt-1">Medals Won</div>
              </div>

              <div className="text-center md:text-left">
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#B8EA80]">10K+</div>
                <div className="text-xs sm:text-sm md:text-base opacity-80 mt-1">Youth Impacted</div>
              </div>

              <div className="text-center md:text-left">
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#B8EA80]">50+</div>
                <div className="text-xs sm:text-sm md:text-base opacity-80 mt-1">Programs</div>
              </div>
            </div>
