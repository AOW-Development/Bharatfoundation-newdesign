...
export default function VolunteerStats() {
  return (
    <section>
      ...
      <div className="relative py-16 sm:py-20 bg-white dark:bg-gray-900 px-6 sm:px-8 md:px-12 lg:px-16">
        <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-3">
              Our Impact
...
function StatCard({
  ...
  return (
    <div id={`stat-${label}`} className="group relative">
      <div className="relative bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-700 overflow-hidden">
        {/* Icon */}
        <div className="flex justify-center mb-6">
          <Icon className="w-16 h-16 text-emerald-600 dark:text-emerald-400 transform group-hover:scale-110 transition-all duration-300" />
        </div>
