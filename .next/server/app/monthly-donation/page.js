(() => {
    ...
    (e.modules = {
      ...
      32238: (e, t, n) => {
        ...
        let d = [
              ...
              children: [
                "monthly-donation",
                {
                  children: [
                    ...
                    {
                      page: [
                        () => Promise.resolve().then(n.bind(n, 62269)),
                        "D:\\Development\\bsf-sureshdesign\\app\\monthly-donation\\page.tsx",
                      ],
                    },
                  ],
                },
                {
                  metadata: {
                    icon: [
                      async (e) =>
                        (
                          await Promise.resolve().then(n.bind(n, 46055))
                        ).default(e),
                    ],
                    apple: [],
                    openGraph: [],
            ...
            {
              layout: [
                () => Promise.resolve().then(n.bind(n, 19611)),
              ...
              forbidden: [
                () => Promise.resolve().then(n.t.bind(n, 69116, 23)),
                "next/dist/client/components/forbidden-error",
              ],
              unauthorized: [
                () => Promise.resolve().then(n.t.bind(n, 41485, 23)),
                "next/dist/client/components/unauthorized-error",
              ],
              metadata: {
                icon: [
                  async (e) =>
                    (await Promise.resolve().then(n.bind(n, 46055))).default(e),
                ],
                apple: [],
                openGraph: [],
                twitter: [],
          ...
          u = new o.AppPageRouteModule({
            definition: {
              ...
              page: "/monthly-donation/page",
              pathname: "/monthly-donation",
              bundlePath: "",
              filename: "",
              appPaths: [],
            },
      ...
      14475: (e, t, n) => {
        Promise.resolve().then(n.bind(n, 48164));
      },
      48164: (e, t, n) => {
        "use strict";
          ...
          return (0, o.jsxs)("main", {
            ...
            children: [
              ...
              (0, o.jsx)(l.default, {
                ...
                paragraph:
                  "Join us in making a difference by selecting your donation amount.",
                buttons: [
                        ...
                        children: [
                              ...
                              (0, o.jsx)("div", {
                                ...
                                children: [
                                  ...
                                  },
                                  {
                                    amount: 1e3,
                                    description:
                                      "Provide meals for 5 underprivileged families.",
                                  },
                                  {
                                    amount: 1500,
                                    description:
                                      "Help buy school supplies for children.",
                                  },
                                  {
                                    amount: 2e3,
                                    description:
                                      "Donate medical aid for a needy patient.",
                                  },
                                  {
                                    amount: 2500,
                                    description:
                                      "Provide shelter support for a homeless person.",
                                  },
                                  {
                                    amount: 3e3,
                                    description:
                                      "Contribute towards clean drinking water projects.",
                                  },
                                  {
                                    amount: 5e3,
                                    description:
                                      "Support skill training for unemployed youth.",
                                  },
                                  {
                                    amount: 1e4,
                                    description:
                                      "Fund a small business startup for a family.",
                                  },
                                ].map((t, n) =>
                                  (0, o.jsxs)(
                                    "button",
                          ...
                          (0, o.jsx)("div", {
                            ...
                            children: (0, o.jsxs)("button", {
                              onClick: () => {
                                e.length > 0
                                  ? n.push(`/donate?amount=${u}`)
                                  : alert(
                                      "Please select at least one donation amount to proceed."
                                    );
                              },
                              className:
      ...
      62269: (e, t, n) => {
        ...
        let o = (0, n(46760).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"D:\\\\Development\\\\bsf-sureshdesign\\\\app\\\\monthly-donation\\\\page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component."
            );
          },
          "D:\\Development\\bsf-sureshdesign\\app\\monthly-donation\\page.tsx",
          "default"
  ...
  t.C(e);
  var n = (e) => t((t.s = e)),
    o = t.X(0, [638, 776, 392, 746], () => n(32238));
  module.exports = o;
})();
