...
(() => {
    ...
    (e.modules = {
        ...
        let d = [
              ...
              children: [
                "what-we-do",
                {
                  children: [
                    ...
                    {
                      page: [
                        () => Promise.resolve().then(r.bind(r, 72683)),
                        "D:\\Development\\bsf-sureshdesign\\app\\what-we-do\\page.tsx",
                      ],
                    },
                  ],
                },
            ...
            },
            {
              ...
              metadata: {
                icon: [
                  async (e) =>
                    (await Promise.resolve().then(r.bind(r, 46055))).default(e),
                ],
                apple: [],
                openGraph: [],
                twitter: [],
          ...
          c = ["D:\\Development\\bsf-sureshdesign\\app\\what-we-do\\page.tsx"],
      ...
      72683: (e, t, r) => {
        ...
        let l = (0, o.A)("Timer", [
          ...
          d = (0, o.A)("ChartNoAxesColumn", [
            ["line", { x1: "18", x2: "18", y1: "20", y2: "10", key: "1xfpm4" }],
            ["line", { x1: "12", x2: "12", y1: "20", y2: "4", key: "be30l9" }],
            ["line", { x1: "6", x2: "6", y1: "20", y2: "14", key: "1r4le6" }],
          ]);
        var c = r(97091);
        let h = (0, o.A)("Microscope", [
        ...
        function v() {
          return (0, s.jsxs)("main", {
            ...
            children: [
              ...
              (0, s.jsx)("section", {
                className:
                  "md:py-16 px-8 md:px-16 py-8 bg-gray-50 dark:bg-gray-800",
                    ...
                    (0, s.jsxs)("div", {
                      ...
                      children: [
                        ...
                        (0, s.jsx)("p", {
                          ...
                          children:
                            "Our mission is to promote physical education and sports at all levels, empowering athletes and communities through our various initiatives and programs. Our vision is to foster a culture where sports are an integral part of everyday life, enhancing the well-being and success of individuals and communities alike.",
                        }),
                      ],
                    }),
                    (0, s.jsxs)("div", {
                      ...
                      children: [
                        (0, s.jsxs)("div", {
                          className:
                            "bg-[#16A34A] dark:bg-[#98c889] p-6 rounded-lg",
                          children: [
                            (0, s.jsx)("h3", {
                              className:
                                "text-xl font-bold mb-4 dark:text-gray-800",
                              children: "Key Areas of Impact",
                            }),
                            (0, s.jsxs)("ul", {
                              className: "space-y-2 dark:text-gray-800",
                              children: [
                                (0, s.jsx)("li", {
                                  children: "Community Engagement",
                                }),
                                (0, s.jsx)("li", {
                                  children: "Athlete Support",
                                }),
                                (0, s.jsx)("li", {
                                  children: "Health & Wellness Programs",
                                }),
                                (0, s.jsx)("li", {
                        ...
                        (0, s.jsxs)("div", {
                          className:
                            "bg-[#98c889] dark:bg-[#16A34A] p-6 rounded-lg",
                          children: [
                            (0, s.jsx)("h3", {
                              className:
                                "text-xl font-bold mb-4 dark:text-gray-800",
                            ...
                            (0, s.jsx)("blockquote", {
                              className: "italic dark:text-gray-800",
                              children:
                                '"Thanks to the Foundation, I\'ve achieved my dream of becoming a national athlete!" - Anjali Sharma',
                            }),
                          ],
                        }),
                      ],
                      ...
                      children: [
                        ...
                        (0, s.jsxs)("div", {
                          ...
                          children: [
                            (0, s.jsx)("div", {
                              className:
                                "text-3xl font-bold mb-2 dark:text-gray-800",
                              children: "120+",
                            }),
                            (0, s.jsx)("div", {
              ...
              (0, s.jsx)("section", {
                ...
                children: (0, s.jsxs)("div", {
                  ...
                  children: [
                    (0, s.jsx)("h2", {
                      className:
                        "text-3xl font-bold text-center mb-12 dark:text-white",
                      children: "Current Programs",
                    }),
                    (0, s.jsx)("div", {
                        ...
                        (0, s.jsxs)(
                          "div",
                          {
                            ...
                            children: [
                              ...
                              (0, s.jsx)("button", {
                                className:
                                  "px-6 py-2 border rounded hover:bg-gray-50 dark:hover:bg-gray-700 dark:text-white dark:border-gray-600",
                                children: "Explore",
                              }),
                            ],
                          },
                ...
                children: (0, s.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, s.jsx)("div", {
                      ...
                      children: [
                        { icon: l, title: "Flexible Training Hours" },
                        { icon: d, title: "Competitive Awards" },
                        { icon: c.A, title: "Free drinks & snacks" },
                        { icon: h, title: "Referral Program" },
                        { icon: m.A, title: "Wellness Activities" },
                        { icon: x.A, title: "Healthcare Support" },
                        { icon: p.A, title: "Annual Sports Event" },
                        { icon: u, title: "Modern Training Facilities" },
                      ].map((e, t) =>
                        (0, s.jsxs)(
                          "div",
                          {
                            ...
                            children: [
                              (0, s.jsx)("div", {
                                className:
                                  "bg-[#16A34A] dark:bg-[#98c889] p-4 rounded-lg mb-4",
                                children: (0, s.jsx)(e.icon, {
                                  className: "h-8 w-8 dark:text-gray-800",
                                }),
                              }),
                              (0, s.jsx)("h3", {
                    ...
                    (0, s.jsxs)("div", {
                      className:
                        "bg-gray-700 text-white text-center py-16 rounded-lg",
                      children: [
                        (0, s.jsx)("h3", {
                        ...
                        (0, s.jsx)("button", {
                          className:
                            "bg-[#16A34A] text-black px-8 py-3 rounded-lg font-semibold hover:bg-[#98c889] transition-colors",
                          children: "Join Now",
                        }),
                      ],
                    }),
              ...
              (0, s.jsx)("section", {
                className: "py-16 md:px-16 px-8 dark:bg-gray-900",
                children: (0, s.jsxs)("div", {
                  className: "container mx-auto px-4",
                  children: [
                    (0, s.jsxs)("div", {
                      ...
                      children: [
                        (0, s.jsxs)("div", {
                          children: [
                            (0, s.jsx)("h2", {
                              className:
                                "text-3xl font-bold mb-6 dark:text-white",
                              children: "Featured Program",
                            }),
                            (0, s.jsx)("h3", {
                              className: "text-2xl mb-4 dark:text-gray-300",
                              children: "Sports Coach",
                            }),
                          ],
                        }),
                        (0, s.jsx)("div", {
                    ...
                    (0, s.jsxs)("div", {
                      className:
                        "bg-[#16A34A] dark:bg-[#98c889] p-8 rounded-lg",
                      children: [
                        (0, s.jsx)("h3", {
                          className:
                            "text-2xl font-bold text-center mb-6 dark:text-gray-800",
                          children: "Program Overview",
                        }),
                        (0, s.jsx)("p", {
                          className: "text-center mb-8 dark:text-gray-800",
                          children:
                            "We are dedicated to empowering youth through sports programs. Join us to make a difference in the community and inspire the next generation of athletes.",
                        }),
                        (0, s.jsxs)("div", {
                          className:
                            "grid md:grid-cols-2 gap-8 bg-[#98c889]/50 dark:bg-[#16A34A]/50 p-6 rounded-lg",
                          children: [
                            (0, s.jsxs)("div", {
                              children: [
                                (0, s.jsx)("h4", {
                                  className:
                                    "font-bold mb-4 dark:text-gray-800",
                                  children: "Activities:",
                                }),
                                (0, s.jsxs)("ul", {
                                  className: "space-y-2 dark:text-gray-800",
                                  children: [
                                    (0, s.jsx)("li", {
                                      children:
                                        "- Plan and execute sports activities",
                                    }),
                                    (0, s.jsx)("li", {
                                      children:
                                        "- Mentor and guide young athletes",
                                    }),
                                    (0, s.jsx)("li", {
                                      children:
                                    ...
                                    (0, s.jsx)("li", {
                                      children:
                                        "- Stay updated on sports trends and techniques",
                                    }),
                                  ],
                                }),
                              ],
                              ...
                              children: [
                                ...
                                (0, s.jsxs)("ul", {
                                  ...
                                  children: [
                                    ...
                                    (0, s.jsx)("li", {
                                      children: "- Ability to work in a team",
                                    }),
                                    (0, s.jsx)("li", {
                                      children:
  ...
  t.C(e);
  var r = (e) => t((t.s = e)),
    s = t.X(0, [638, 776, 392, 635, 746], () => r(15026));
  module.exports = s;
})();
=======
const CHUNK_PUBLIC_PATH = "server/app/what-we-do/page.js";
...
runtime.loadChunk("server/chunks/ssr/node_modules_dff7f7._.js");
runtime.loadChunk("server/chunks/ssr/_45c982._.js");
runtime.getOrInstantiateRuntimeModule("[project]/.next-internal/server/app/what-we-do/page/actions.js [app-rsc] (ecmascript)", CHUNK_PUBLIC_PATH);
module.exports = runtime.getOrInstantiateRuntimeModule("[project]/node_modules/next/dist/esm/build/templates/app-page.js?page=/what-we-do/page { METADATA_0 => \"[project]/app/favicon.ico.mjs { IMAGE => \\\"[project]/app/favicon.ico [app-rsc] (static)\\\" } [app-rsc] (structured image object, ecmascript, Next.js server component)\", MODULE_1 => \"[project]/app/layout.tsx [app-rsc] (ecmascript, Next.js server component)\", MODULE_2 => \"[project]/node_modules/next/dist/client/components/not-found-error.js [app-rsc] (ecmascript, Next.js server component)\", MODULE_3 => \"[project]/node_modules/next/dist/client/components/forbidden-error.js [app-rsc] (ecmascript, Next.js server component)\", MODULE_4 => \"[project]/node_modules/next/dist/client/components/unauthorized-error.js [app-rsc] (ecmascript, Next.js server component)\", MODULE_5 => \"[project]/app/what-we-do/page.tsx [app-rsc] (ecmascript, Next.js server component)\" } [app-rsc] (ecmascript)", CHUNK_PUBLIC_PATH).exports;
